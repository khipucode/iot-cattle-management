...
CREATE TABLE `alerts` (
  ...
  `alert_type` enum('health','device','environment','security','other') DEFAULT NULL,
  ...
  CONSTRAINT `1` FOREIGN KEY (`cattle_id`) REFERENCES `cattle` (`cattle_id`),
  CONSTRAINT `2` FOREIGN KEY (`device_id`) REFERENCES `devices` (`device_id`),
  CONSTRAINT `3` FOREIGN KEY (`site_id`) REFERENCES `sites` (`site_id`),
  CONSTRAINT `4` FOREIGN KEY (`location_id`) REFERENCES `locations` (`location_id`)
...
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `cattle` (
  `cattle_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `ear_tag_code` varchar(50) DEFAULT NULL,
  `birth_date` date DEFAULT NULL,
  `breed` varchar(50) DEFAULT NULL,
  `purchase_price` decimal(10,2) DEFAULT NULL,
  `photo_url` varchar(255) DEFAULT NULL,
  `status` enum('active','sold','dead','missing') DEFAULT NULL,
  `current_lot_id` bigint(20) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`cattle_id`),
  UNIQUE KEY `ear_tag_code` (`ear_tag_code`)
...
--
-- Table structure for table `cattle_births`
--

DROP TABLE IF EXISTS `cattle_births`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `cattle_births` (
  `birth_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `mother_id` bigint(20) DEFAULT NULL,
  `calf_id` bigint(20) DEFAULT NULL,
  ...
  CONSTRAINT `1` FOREIGN KEY (`mother_id`) REFERENCES `cattle` (`cattle_id`),
  CONSTRAINT `2` FOREIGN KEY (`calf_id`) REFERENCES `cattle` (`cattle_id`),
  CONSTRAINT `3` FOREIGN KEY (`site_id`) REFERENCES `sites` (`site_id`),
  CONSTRAINT `4` FOREIGN KEY (`location_id`) REFERENCES `locations` (`location_id`),
  CONSTRAINT `5` FOREIGN KEY (`operator_id`) REFERENCES `operators` (`operator_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `cattle_breeding`
--

DROP TABLE IF EXISTS `cattle_breeding`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `cattle_breeding` (
  `breeding_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `female_id` bigint(20) DEFAULT NULL,
  `male_id` bigint(20) DEFAULT NULL,
  `breeding_date` datetime DEFAULT NULL,
  `method` enum('natural','artificial') DEFAULT NULL,
  `operator_id` bigint(20) DEFAULT NULL,
  `result` enum('pending','success','failure') DEFAULT NULL,
  `notes` text DEFAULT NULL,
  PRIMARY KEY (`breeding_id`),
  KEY `female_id` (`female_id`),
  KEY `male_id` (`male_id`),
  KEY `operator_id` (`operator_id`),
  CONSTRAINT `1` FOREIGN KEY (`female_id`) REFERENCES `cattle` (`cattle_id`),
  CONSTRAINT `2` FOREIGN KEY (`male_id`) REFERENCES `cattle` (`cattle_id`),
  CONSTRAINT `3` FOREIGN KEY (`operator_id`) REFERENCES `operators` (`operator_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `cattle_deaths`
--

DROP TABLE IF EXISTS `cattle_deaths`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `cattle_deaths` (
  `death_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `cattle_id` bigint(20) DEFAULT NULL,
  ...
  KEY `operator_id` (`operator_id`),
  CONSTRAINT `1` FOREIGN KEY (`cattle_id`) REFERENCES `cattle` (`cattle_id`),
  CONSTRAINT `2` FOREIGN KEY (`operator_id`) REFERENCES `operators` (`operator_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `cattle_feeding`
--

DROP TABLE IF EXISTS `cattle_feeding`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `cattle_feeding` (
  `feeding_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `cattle_id` bigint(20) DEFAULT NULL,
  `feeding_date` datetime DEFAULT NULL,
  `feed_type` enum('pasture','silage','grain','supplement','other') DEFAULT NULL,
...
DROP TABLE IF EXISTS `cattle_health`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `cattle_health` (
  ...
  `vet_name` varchar(128) DEFAULT NULL,
  `notes` text DEFAULT NULL,
...
--
-- Table structure for table `cattle_milking`
--

DROP TABLE IF EXISTS `cattle_milking`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `cattle_milking` (
  `milking_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `cattle_id` bigint(20) DEFAULT NULL,
  `milking_date` datetime DEFAULT NULL,
  `milk_quantity` decimal(8,2) DEFAULT NULL,
  `operator_id` bigint(20) DEFAULT NULL,
  `notes` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`milking_id`),
  KEY `cattle_id` (`cattle_id`),
  KEY `operator_id` (`operator_id`),
  CONSTRAINT `1` FOREIGN KEY (`cattle_id`) REFERENCES `cattle` (`cattle_id`),
  CONSTRAINT `2` FOREIGN KEY (`operator_id`) REFERENCES `operators` (`operator_id`)
...
--
-- Table structure for table `cattle_missing`
--

DROP TABLE IF EXISTS `cattle_missing`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `cattle_missing` (
  `missing_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `cattle_id` bigint(20) DEFAULT NULL,
  `report_date` datetime DEFAULT NULL,
  `site_id` bigint(20) DEFAULT NULL,
  `location_id` bigint(20) DEFAULT NULL,
  `operator_id` bigint(20) DEFAULT NULL,
  `status` enum('missing','found') DEFAULT NULL,
  `notes` varchar(255) DEFAULT NULL,
  ...
  KEY `operator_id` (`operator_id`),
  CONSTRAINT `1` FOREIGN KEY (`cattle_id`) REFERENCES `cattle` (`cattle_id`),
  CONSTRAINT `2` FOREIGN KEY (`site_id`) REFERENCES `sites` (`site_id`),
  CONSTRAINT `3` FOREIGN KEY (`location_id`) REFERENCES `locations` (`location_id`),
  CONSTRAINT `4` FOREIGN KEY (`operator_id`) REFERENCES `operators` (`operator_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `cattle_movements`
--

DROP TABLE IF EXISTS `cattle_movements`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `cattle_movements` (
  ...
  `from_lot_id` bigint(20) DEFAULT NULL,
  `to_lot_id` bigint(20) DEFAULT NULL,
  ...
  CONSTRAINT `1` FOREIGN KEY (`cattle_id`) REFERENCES `cattle` (`cattle_id`),
  CONSTRAINT `2` FOREIGN KEY (`from_site_id`) REFERENCES `sites` (`site_id`),
  CONSTRAINT `3` FOREIGN KEY (`to_site_id`) REFERENCES `sites` (`site_id`),
  CONSTRAINT `4` FOREIGN KEY (`from_lot_id`) REFERENCES `lots` (`lot_id`),
  CONSTRAINT `5` FOREIGN KEY (`to_lot_id`) REFERENCES `lots` (`lot_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `cattle_photos`
--

DROP TABLE IF EXISTS `cattle_photos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `cattle_sales`
--

DROP TABLE IF EXISTS `cattle_sales`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `cattle_tags`
--
...
CREATE TABLE `cattle_tags` (
  ...
  `cattle_id` bigint(20) DEFAULT NULL,
  `tag_type` enum('ear_tag','collar','brand','other') DEFAULT NULL,
...
--
-- Table structure for table `cattle_treatments`
--

DROP TABLE IF EXISTS `cattle_treatments`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `cattle_treatments` (
  `treatment_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `cattle_id` bigint(20) DEFAULT NULL,
  `treatment_date` datetime DEFAULT NULL,
  `treatment_type` varchar(128) DEFAULT NULL,
...
--
-- Table structure for table `cattle_vaccinations`
--

DROP TABLE IF EXISTS `cattle_vaccinations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `cattle_vaccinations` (
  `vaccination_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `cattle_id` bigint(20) DEFAULT NULL,
  `vaccine_name` varchar(128) DEFAULT NULL,
...
CREATE TABLE `cattle_weights` (
  ...
  KEY `location_id` (`location_id`),
  CONSTRAINT `1` FOREIGN KEY (`cattle_id`) REFERENCES `cattle` (`cattle_id`),
  CONSTRAINT `2` FOREIGN KEY (`location_id`) REFERENCES `locations` (`location_id`)
...
CREATE TABLE `devices` (
  ...
  `device_type` enum('rfid_stick','jetson','gateway','sensor','node') DEFAULT NULL,
  `site_id` bigint(20) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `last_seen_at` datetime DEFAULT NULL,
  PRIMARY KEY (`device_id`),
  KEY `site_id` (`site_id`),
  CONSTRAINT `1` FOREIGN KEY (`site_id`) REFERENCES `sites` (`site_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `ear_tags`
--

DROP TABLE IF EXISTS `ear_tags`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `environment_samples`
--
...
CREATE TABLE `events_raw` (
  ...
  CONSTRAINT `2` FOREIGN KEY (`device_id`) REFERENCES `devices` (`device_id`),
  CONSTRAINT `3` FOREIGN KEY (`operator_id`) REFERENCES `operators` (`operator_id`),
  CONSTRAINT `4` FOREIGN KEY (`site_id`) REFERENCES `sites` (`site_id`),
  CONSTRAINT `5` FOREIGN KEY (`location_id`) REFERENCES `locations` (`location_id`)
...
CREATE TABLE `locations` (
  ...
  `LOCATION_TYPE` enum('water_point','gate','paddock','scale','shed','other') DEFAULT NULL,
...
CREATE TABLE `lots` (
  ...
  `lot_name` varchar(128) DEFAULT NULL,
  `site_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`lot_id`),
...
CREATE TABLE `operators` (
  ...
  `role` enum('admin','vet','worker','viewer') DEFAULT NULL,
...
CREATE TABLE `sites` (
  ...
  `site_type` enum('farm','corral','pasture','barn','other') DEFAULT NULL,
  PRIMARY KEY (`site_id`),
...
-- Dump completed on 2026-03-16 19:00:42
